...
class Main {
  ...
  tabListeners() {
    console.log('tab_bounds', this.tab_bounds)
...
/** import & featurebox script */
// var featurebox = document.getElementById('feature-box')
// var body = document.querySelector('body')

// var start = Date.now()

// featurebox.addEventListener('load', () => {
//   var main = document.querySelector('body main')


//   var featurebox_document = featurebox.contentWindow.document
//   featurebox.contentWindow.ticons_parent = document.querySelector('.main_header--nav-right')
...
//   body.prepend(mlp_transform)
//   main.prepend(featurebox_styles)
...
//       console.log('from pageloaded evt.detail', evt.detail, Date.now() - start)
  
//       var filter_list = featurebox_html.querySelector('.-filter-list')
//       var interval = setInterval(() => {
//         if (!filter_list.classList.contains('-fetch-loading')) {
//           featurebox.contentWindow.page_location = location
...
//       }, 100);
//     }
//     console.log('from pageloaded evt.detail', detail, Date.now() - start)
...
window.document.addEventListener('dataimported', evt => {
  console.log('from dataimported evt.detail', evt.detail, Date.now() - start)
  new Main(evt.detail)
}, false)
