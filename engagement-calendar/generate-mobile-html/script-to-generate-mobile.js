...
class CategoriesAndMFls {
  constructor() {
    ...
    this.mfls = [
      ...
      { link: '/sp-spin-win-how-to/', icon: 'mfl-spin-win.jpg' },
      { link: '/sp-vouchers-of-the-week/', icon: 'mfl-vouchers.jpg' }
    ]
  }
...
class Logic {
  constructor() {
    ...
    this.linkVariable = 'sp-mobile-apps'
    this.LIVE_LINK = "https://aal4.adj.st/ng/ss/flashsales-app?adjust_t=itk4eyn_9sytz8o&adjust_campaign=NG&adjust_adgroup=FS-20&adjust_creative=FS_PAGE&adjust_deeplink=jumia%3A%2F%2Fng%2Fss%2Fflashsales-app&adjust_redirect=https%3A%2F%2Fwww.jumia.com.ng%2F" + this.linkVariable
    this.host = 'https://www.jumia.com.ng'
    this.host = 'https://www.jumia.com.ng/'
    this.uniqueLinks = {
  ...
  createGroup(sku) {
    ...
    var skuProp = {
      sku: ['a', { href: sku.pdp ? sku.pdp : this.link(sku), class: skuClass, id: this.skuID(sku['name']) }, '', ''],
      imgWrap: ['div', { class: '-img pos-rel' }, '', ''],
      img: ['img', { 'data-src': this.BOB_IMG_LINK + sku.image, alt: 'sku_img' }, '', ''],
      shadow: ['div', { class: 'pos-abs -shadow' }, '', ''],
      sold: ['span', { class: 'pos-abs' }, '', 'sold'],
