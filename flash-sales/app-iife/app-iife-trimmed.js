...
var Begin = (function (data) {
  ...
  class Controller extends Util {
    ...
    setBanner() {
      ...
      banner_img.setAttribute('data-src', "https://ng.jumia.is/cms/0-1-weekly-cps/2021/w26-nsf/0-initiatives/FS_730x292.gif")
  ...
  class State extends Util {
    constructor(json) {
      ...
      this.time_el.classList.add('-hide')
    ...
    updateClockUi(rtime) {
      ...
      this.time_el.setAttribute('style', 'display: inline-block !important')
    }
